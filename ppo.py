...
class PPOTrainer:
    ...
    def step(self, queries, responses, scores):
        ...
        stats = self.record_step_stats(rewards=rewards, logprobs=logprobs, ref_logprobs=ref_logprobs,
    ...
    def record_step_stats(self, kl_coef, **data):
        ...
        mean_reward = torch.mean(torch.stack([torch.sum(rewards) for rewards in data['rewards']]))
        stats = {
