...
PRE_TRAINED_MODEL_NAME = 'rewriting/gpt2-supervised-experiment3/100/best-model'
model = GPT2LMHeadModel.from_pretrained(PRE_TRAINED_MODEL_NAME).to(device)
tokenizer = AutoTokenizer.from_pretrained(PRE_TRAINED_MODEL_NAME)    

prompt = ['[PROMPT]悲伤[SEP]这是由特别事件引起的吗？[REWRITE]',
        '[PROMPT]悲伤[SEP]这是由最近或遥远的事件（或多个事件）引起的吗？[REWRITE]',
        '[PROMPT]悲伤[SEP]您最近是否尝试过协议6，并发现由于旧事件而重新点燃了无法控制的情绪？[REWRITE]',
        '[PROMPT]悲伤[SEP]您最近是否尝试过协议11，并发现由于旧事件而重新点燃了无法控制的情绪？[REWRITE]',
        '[PROMPT]悲伤[SEP]谢谢。现在我会问一些问题以了解您的情况。[REWRITE]',
        '[PROMPT]悲伤[SEP]您是否对某人有强烈的感受或表达以下任何情绪：[REWRITE]',
        '[PROMPT]悲伤[SEP]您认为您应该成为别人的救星吗？[REWRITE]',
        '[PROMPT]悲伤[SEP]您是否将自己视为受害者，将自己的负面情绪归咎于他人？[REWRITE]',
        '[PROMPT]悲伤[SEP]您觉得您在试图控制某人吗？[REWRITE]',
        '[PROMPT]悲伤[SEP]当出现问题时，您是否总是责怪和指责自己？[REWRITE]',
        '[PROMPT]悲伤[SEP]在之前的对话中，您是否考虑过其他提出的观点？[REWRITE]',
        '[PROMPT]悲伤[SEP]您是否正在经历个人危机（与亲人相处有困难，例如与朋友闹翻）？[REWRITE]',
        '[PROMPT]快乐[SEP]那很好！让我推荐一个您可以尝试的协议。[REWRITE]',
        '[PROMPT]所有情绪[SEP]根据您所说的，我相信您正在感受{}。这个对吗？[REWRITE]',
        '[PROMPT]所有情绪[SEP]我很抱歉。请从下面的情绪中选择最能反映您感受的情绪：[REWRITE]',
        '[PROMPT]所有情绪[SEP]感谢您的参与。再见[REWRITE]',
        '[PROMPT]所有情绪[SEP]这是我的建议，请选择您想尝试的协议[REWRITE]',
        '[PROMPT]所有情绪[SEP]请现在尝试通过此协议。完成后，按“继续”[REWRITE]',
        '[PROMPT]所有情绪[SEP]采取此协议后，您感觉更好还是更糟？[REWRITE]',
        '[PROMPT]所有情绪[SEP]您想尝试另一种协议吗？ （病人感觉好多了）[REWRITE]',
        '[PROMPT]所有情绪[SEP]您想尝试另一种协议吗？ （病人感觉更糟)[REWRITE]']
...
def hide():
    ['[PROMPT]男性[SEP]18-39[SEP]悲伤[SEP]这是由特别事件引起的吗？[REWRITE]',
    ...
    '[HIGH]悲伤[SEP]非常感谢你让我知道。你会说是最近或遥远的事件（或事件）引起了这种情绪吗？[REWRITE]',
    '[HIGH]悲伤[SEP]您最近是否尝试过协议6，并发现由于旧事件而重新点燃了无法控制的情绪？[REWRITE]',
    '[HIGH]悲伤[SEP]谢谢你，也许协议 11 可以帮助你处理这个事件，但是在我推荐它之前，我想确保你过去没有遇到过糟糕的经历。你是否已经尝试过协议 11，如果是，它是否激起了困难或创伤性的情绪？[REWRITE]',
    '[HIGH]悲伤[SEP]谢谢。现在我会问一些问题以了解您的情况。[REWRITE]',
    '[HIGH]悲伤[SEP]我知道这可能很困难，但如果您能与我分享这一点，我会非常感激。请问您是否对某人表达或感受到了以下强烈的情绪：[REWRITE]',
    '[HIGH]悲伤[SEP]您认为您应该成为别人的救星吗？[REWRITE]',
    '[HIGH]悲伤[SEP]我想知道你对你在这个角色中的角色有什么看法。在目前的情况下，您是否觉得自己是一个受害者，想要将自己的负面情绪转移到其他人身上？[REWRITE]',
    '[HIGH]悲伤[SEP]您觉得您在试图控制某人吗？[REWRITE]',
    '[HIGH]悲伤[SEP],嗯，我明白了，谢谢你花时间回答所有这些问题，我仍在努力找出最好的帮助方式。你会说当出现问题时，你有把矛头指向自己的倾向吗？[REWRITE]',
    '[HIGH]悲伤[SEP]在之前的对话中，您是否考虑过其他提出的观点？[REWRITE]',
    '[HIGH]悲伤[SEP]很抱歉让您感到难过，为了帮助您，我想深入挖掘一下。如果你不介意我问一下，你正在经历一场艰难的个人危机吗？[REWRITE]',
    '[HIGH]快乐[SEP]那很好！让我推荐一个您可以尝试的协议。[REWRITE]',
    '[HIGH]所有情绪[SEP]感谢您通过分享您的感受来信任我。从你告诉我的情况来看，我相信你有 {} 的感觉？[REWRITE]',
    '[HIGH]所有情绪[SEP]我很抱歉。请从下面的情绪中选择最能反映您感受的情绪：[REWRITE]',
    '[HIGH]所有情绪[SEP]再见,我要感谢您今天与我分享您的想法和感受。我真的很想很快再见到你，所以请你有空的时候过来看看。[REWRITE]',
    '[HIGH]所有情绪[SEP]这是我的建议，请选择您想尝试的协议[REWRITE]',
    '[HIGH]所有情绪[SEP]太好了，我很高兴您愿意尝试一下，希望您会发现它很有帮助。请在准备好后仔细阅读协议，如果完成后可以按“继续”，那就太好了。[REWRITE]',
    '[HIGH]所有情绪[SEP]采取此协议后，您感觉更好还是更糟？[REWRITE]',
    '[HIGH]所有情绪[SEP]非常好。如您所知，列表中还有更多协议，您是否认为您可能想尝试其他协议，看看情况如何？[REWRITE]',
