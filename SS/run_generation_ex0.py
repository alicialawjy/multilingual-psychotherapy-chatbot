...
def run_RL():
    ##### P A R A M E T E R S ######
    config = {
        "lm_name": 'rewriting/gpt2-supervised-experiment0-up/100/best-model',         # generative model (gpt2) 
...
# 57848: attempt 10: 
#    https://wandb.ai/alicialawjy/satbot/runs/2m1aptv4?workspace=user-alicialawjy
# 57850: attempt 11:
#    https://wandb.ai/alicialawjy/satbot/runs/2m0ggk1a
