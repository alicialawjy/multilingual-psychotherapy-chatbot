const protocol_dict = {
    ...
    "17_ZH": {
        "title": "解决个人危机",
        "content":"此练习针对正在生活中经历个人危机的用户，例如与朋友/家人闹翻等。用户首先将现在的情绪投射到 童年的自我，然后在练习15的基础上询问童年的自我此事件是否跟练习15的三点有关。完成后用户反省 这次事件是否是个自我提升的机会。鼓励用户在实行以上步骤时尝试练习12。最终用户从成年自我的角 度分析自己的经历，与曾经的经历做对比，并分析自己是否有可以提升的地方。\
        "
    },
    "18_ZH": {
        "title": "认出无害矛盾性并从其取乐",
