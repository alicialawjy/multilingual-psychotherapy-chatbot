...
PRE_TRAINED_MODEL_NAME = 'rewriting/gpt2-supervised-experiment3/50/checkpoint-40500'
...
df_responses.to_csv('ex3_checkpoint40500_results.csv')

##### experiment 0 [PROMPT] emo [SEP] base [REWRITE] x upsample #####
# 57509 (no upsample): best model
